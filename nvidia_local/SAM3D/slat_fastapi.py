...
Usage:
  ...
  python -m SAM3D.slat_fastapi --checkpoint-dir ./models/sam-3d-objects/checkpoints --port 8001
"""
...
from SAM3D.slat_service import init_models, decode_mesh, batch_decode_meshes
